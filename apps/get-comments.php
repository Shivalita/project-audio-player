...
echo ('
    <div class="col-12 text-center">
        <h3><b class="text-white">'.$title.'</b></h3>
');
if ($commentsCount < 2) {
    echo ('<h5 class="mt-3 mb-5">'.$commentsCount.' comment</h5>');
} else {
    echo ('<h5 class="mt-3 mb-5">'.$commentsCount.' comments</h5>');
}      
echo ('</div>');
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div id="noCommentsYet" class="col-12 col-md-8 mt-5 mb-5 cardText">
                    <h3 class="mb-4 mt-3"><b class="text-white">This song hasn\'t been commented yet<b></h3>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div id="signForComment" class="col-12 col-md-8 mt-5 cardText">
                    <h3 class="mb-4 mt-3"><b class="text-white">Join us to comment<b></h3>
